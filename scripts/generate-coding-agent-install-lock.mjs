...
const internalPackagePrefix = "@letty/letty-";
const internalPackageNames = new Set(["@letty/chord"]);
const installPackageName = "@letty/letty-coding-agent-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the Letty installer and updater.",
		dependencies: {
