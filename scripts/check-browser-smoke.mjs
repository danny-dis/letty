...
const outputPath = join(tmpdir(), "letty-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "letty-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "letty-browser-smoke-errors.log");
