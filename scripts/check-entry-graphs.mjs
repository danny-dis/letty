...
const WORKSPACE = {
	"@letty/chord": "packages/chord/src",
	"@letty/letty-ai": "packages/ai/src",
	"@letty/letty-agent-core": "packages/agent/src",
	"@letty/letty-telemetry": "packages/telemetry/src",
	"@letty/letty-tui": "packages/tui/src",
};
