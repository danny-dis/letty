...
const banner = {
	js: 'import { createRequire as __lettyCreateRequire } from "node:module"; const require = __lettyCreateRequire(import.meta.url);',
};
...
function commonBuildOptions() {
	return {
		...
		banner,
		bundle: true,
		define: { LETTY_BUNDLED_NODE: "true" },
		external: ["@letty/chord", "@silvia-odwyer/photon-node"],
		format: "esm",
		legalComments: "none",
		logLevel: "warning",
		metafile: true,
