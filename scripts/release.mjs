 ...
 * 10. Push main and the tag to trigger CI publication and verified letty.dev announcement
 */
...
console.log(`=== Prepared release v${version}; CI publication and letty.dev announcement start after the tag push ===`);
