/**
 * Temporary compatibility entrypoint preserving the old global letty-ai API
 ...
 *
 * Existing apps switch imports from "@letty/letty-ai" to
 * "@letty/letty-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/letty-messages.lazy.ts";
...
import { lettyMessagesApi } from "./api/letty-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@letty/letty-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@letty/letty-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@letty/letty-ai/providers/all" or `Models.getProviders()`. */
...
const BUILTIN_APIS: [Api, ProviderStreams][] = [
	...
	["letty-messages", lettyMessagesApi()],
];
