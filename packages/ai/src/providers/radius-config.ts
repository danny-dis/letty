...
export const DEFAULT_RADIUS_GATEWAY = "https://radius.letty.dev";
...
export type RadiusGatewayModel = {
	...
	input: ("text" | "image")[];
	cost: Model<"letty-messages">["cost"];
...
export function getRadiusModelsFromConfig(providerId: string, config: RadiusGatewayConfig): Model<"letty-messages">[] {
