...
/**
 * Converts models.dev verified effort values into Letty's selectable thinking levels.
 * Values without a Letty equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
