...
declare const LETTY_BUNDLED_NODE: boolean;
export const isBundledNode = typeof LETTY_BUNDLED_NODE !== "undefined" && LETTY_BUNDLED_NODE;
...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/letty/letty/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.LETTY_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json lettyConfig)
// =============================================================================
...
const lettyConfigName: string | undefined = pkg.lettyConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@letty/letty-coding-agent";
export const APP_NAME: string = lettyConfigName || "letty";
export const APP_TITLE: string = lettyConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.lettyConfig?.configDir || ".letty";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., LETTY_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
const DEFAULT_SHARE_VIEWER_URL = "https://letty.dev/session/";

/** Get the share viewer URL for a gist ID. */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.LETTY_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.letty/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.letty/agent/) */
