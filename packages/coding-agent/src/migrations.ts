...
const MIGRATION_GUIDE_URL =
	"https://github.com/letty/letty/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/letty/letty/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.letty/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.letty/agent/ instead of
 * ~/.letty/agent/sessions/<encoded-cwd>/. This migration moves them
 * to the correct location based on the cwd in their session header.
 *
 * See: https://github.com/letty/letty-mono/issues/320
 */
 ...
 * Note: tools/ may contain fd/rg binaries extracted by letty, so only warn if it has other files.
 */
