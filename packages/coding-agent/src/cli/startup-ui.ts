import { ProcessTerminal, setCapabilityOverrides, setKeybindings, type TUI, TuiMainScreen } from "@letty/letty-tui";
...
const OFFICIAL_PACKAGE_NAME = "@letty/letty-coding-agent";
const OFFICIAL_APP_NAME = "letty";
const OFFICIAL_CONFIG_DIR_NAME = ".letty";
 ...
 * - this is the official Letty distribution (not a fork/rebrand)
 * - experimental features are enabled (LETTY_EXPERIMENTAL=1)
