...
import type { ThinkingLevel } from "@letty/letty-agent-core";
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self|letty]   Update letty, extensions, or model catalogs
...
${chalk.bold("Options:")}
  ...
  --offline                      Disable startup network operations (same as LETTY_OFFLINE=1)
...
${chalk.bold("Environment Variables:")}
  ...
  LETTY_PACKAGE_DIR                   - Override package directory (for Nix/Guix store paths)
  LETTY_OFFLINE                       - Disable startup network operations when set to 1/true/yes
  LETTY_TELEMETRY                     - Override install telemetry when set to 1/true/yes or 0/false/no
  LETTY_SHARE_VIEWER_URL              - Base URL for /share command (default: https://letty.dev/session/)
