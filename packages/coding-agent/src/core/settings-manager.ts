...
import { DEFAULT_MAX_AGENT_RETRY_DELAY_MS, type Transport } from "@letty/letty-ai";
import type { TuiMode as RendererTuiMode, ScrollViewScrollbar, TerminalCapabilities } from "@letty/letty-tui";
...
export interface Settings {
	...
	httpProxy?: string; // Proxy URL applied as HTTP_PROXY and HTTPS_PROXY for Letty-managed HTTP clients
...
export class SettingsManager {
	...
	getClearOnShrink(): boolean {
		...
		return process.env.LETTY_CLEAR_ON_SHRINK === "1";
	}
	...
	getShowHardwareCursor(): boolean {
		return this.settings.showHardwareCursor ?? process.env.LETTY_HARDWARE_CURSOR === "1";
	}
