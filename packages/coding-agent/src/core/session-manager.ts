...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@letty/letty-ai";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, undefined/false if letty-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, false if letty-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.letty/agent/sessions/.
 */
...
export class SessionManager {
	...
	private _setSessionFile(sessionFile: string, preloadedFileEntries?: FileEntry[]): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			// non-empty but did not parse as a letty session, fail without modifying it.
			if (entries.length === 0) {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.letty/agent/sessions/<encoded-cwd>/).
	 */
