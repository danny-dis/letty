...
import { contentText, retryDelayMs } from "@letty/letty-ai";
import type {
	AssistantMessage,
	AuthResult,
	ImageContent,
...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via letty.registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via letty.sendMessage()
	...
	/** Generate Letty's built-in compaction summary for manual and automatic compaction. */
