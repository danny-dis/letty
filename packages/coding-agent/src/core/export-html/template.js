    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="letty-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="letty-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'letty-share:v1:sidebar-width';
