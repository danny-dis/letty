...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@letty/letty-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@letty/letty-ai/compat";
...
// provider-agnostic and does not import letty-ai/compat itself.
setDefaultStreamFn(streamSimple);

export interface CreateAgentSessionOptions {
	/** Working directory for project-local discovery. Default: process.cwd() */
	cwd?: string;
	/** Global config directory. Default: ~/.letty/agent */
	agentDir?: string;
	 ...
	 *
	 * When omitted, letty uses the `defaultTools` setting for the initial built-in
