...
import type { AgentMessage, StreamFn } from "@letty/letty-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@letty/letty-ai";
import { contentText } from "@letty/letty-ai";
import type { Model, SimpleStreamOptions, Usage } from "@letty/letty-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from letty-generated summaries (fromHook !== true), not extension-generated ones
