...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@letty/letty-agent-core";
import { contentText, type RetryCallbacks, type RetryPolicy, retryAssistantCall, uuidv7 } from "@letty/letty-ai";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@letty/letty-ai/compat";
import { completeSimple } from "@letty/letty-ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if letty-generated)
