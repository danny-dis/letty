...
import type { ImageContent, TextContent } from "@letty/letty-ai";
...
function getLettyDocsClassification(absolutePath: string): CompactReadClassification | undefined {
...
function getCompactReadClassification(
	...
	const docsClassification = getLettyDocsClassification(absolutePath);
