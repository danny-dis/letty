import type { Api, Model, ModelsStoreEntry, Provider } from "@letty/letty-ai";
import { VERSION } from "../config.ts";
import { getLettyUserAgent } from "../utils/letty-user-agent.ts";
import { fetchWithRetry } from "../utils/management-http.ts";

const DEFAULT_CATALOG_BASE_URL = "https://letty.dev";
...
/** Add a persisted letty.dev catalog overlay to a static built-in provider. */
