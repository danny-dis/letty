 ...
 * Provider auth orchestration belongs to ModelRuntime and letty-ai Models.
 */

import type { AuthOperationOptions, Credential, CredentialInfo, CredentialStore } from "@letty/letty-ai";
