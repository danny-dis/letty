import type { AuthInfoLink, OAuthDeviceCodeInfo } from "@letty/letty-ai";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@letty/letty-tui";
