...
import type { HarnessEvent, LaneSnapshot } from "@letty/letty-agent-core";
...
export interface ProviderAccount {
	...
	source?: string;
	/** False for ambient credentials letty cannot collect itself, such as AWS profiles or env vars. */
	interactive: boolean;
	methodName?: string;
}
