...
import { Client, ServerError } from "@letty/letty-client";
import { createUnixTransportFactory, discoverUnixServers, type UnixServerRoute } from "@letty/letty-client/unix";
...
export interface OpenClientRuntimeOptions {
	/** Directory searched when --connect is omitted. Defaults to LETTY_SERVER_DIR or ~/.letty/server. */
