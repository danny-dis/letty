import { type Context, defineService, type JsonValue } from "@letty/chord";
...
export const PresentationPlugins = defineService<PresentationPlugins>("letty.presentation-plugins");
...
export const SessionPlugins = defineService<SessionPlugins>("letty.session-plugins");
