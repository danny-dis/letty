import { combineFacetLoaders, type FacetLoader, type JsonValue } from "@letty/chord";
import {
...
const LETTY_PLUGIN_API = "@letty/letty-coding-agent/experimental/plugin";
...
function resolvePluginExternal(specifier: string): string | undefined {
	if (specifier !== LETTY_PLUGIN_API) return undefined;
