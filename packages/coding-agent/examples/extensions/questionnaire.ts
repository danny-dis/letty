...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@letty/letty-tui";
...
export default function questionnaire(letty: ExtensionAPI) {
	letty.registerTool({
		name: "questionnaire",
		label: "Questionnaire",
		description:
