 ...
 * Commands Extension
 *
 * Demonstrates the letty.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@letty/letty-coding-agent";

export default function commandsExtension(letty: ExtensionAPI) {
	letty.registerCommand("commands", {
