 ...
 * working indicator shown while letty is streaming a response.
 *
 * Usage:
 *   letty --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore letty's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@letty/letty-coding-agent";
...
export default function (letty: ExtensionAPI) {
	...
	letty.registerCommand("working-indicator", {
