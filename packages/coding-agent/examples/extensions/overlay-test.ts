 ...
 *
 * Usage: letty --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@letty/letty-tui";

export default function (letty: ExtensionAPI) {
	letty.registerCommand("overlay-test", {
