 ...
 * - Routing tool calls to remote systems (e.g., letty-ssh-remote)
...
import type { TextContent } from "@letty/letty-ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@letty/letty-coding-agent";
...
export default function (letty: ExtensionAPI) {
	...
	letty.registerCommand("read-log", {
