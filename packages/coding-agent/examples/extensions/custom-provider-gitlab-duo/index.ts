 ...
 * Delegates to letty-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   letty -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (letty: ExtensionAPI) {
	letty.registerProvider("gitlab-duo", {
