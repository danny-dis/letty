import { uuidv7 } from "@letty/letty-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@letty/letty-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@letty/letty-coding-agent";
import { Container, Markdown, matchesKey, Text } from "@letty/letty-tui";
...
export default function (letty: ExtensionAPI) {
	letty.registerCommand("summarize", {
