import { defineFacet } from "@letty/chord";
import { AgentController, PresentationUI, SlashCommands } from "@letty/letty-coding-agent/experimental/plugin";
import { ExampleFacetService } from "./contract.ts";

export default defineFacet({
	id: "@letty/letty-example-plugin/tui",
	setup(env) {
