...
vi.mock("@letty/letty-coding-agent", () => ({
...
describe("Documentation example", () => {
	it("custom compaction example should type-check correctly", () => {
		...
		const exampleExtension = (letty: ExtensionAPI) => {
			letty.on("session_before_compact", async (event: SessionBeforeCompactEvent, ctx) => {
	...
	it("compact event should have correct fields", () => {
		const checkCompactEvent = (letty: ExtensionAPI) => {
			letty.on("session_compact", async (event: SessionCompactEvent) => {
