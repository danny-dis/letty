...
/**
 * Regression test for https://github.com/letty/letty/issues/3303
 *
...
describe("issue #3303 nested .gitignore rules leak into sibling directories", () => {
	...
	describe("flat sibling case", () => {
		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "letty-3303-flat-"));
	...
	describe("deeply nested case", () => {
		beforeEach(() => {
			tempRoot = mkdtempSync(join(tmpdir(), "letty-3303-deep-"));
