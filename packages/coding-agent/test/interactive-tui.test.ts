import type { Component, Terminal, TUI } from "@letty/letty-tui";
import { Container, getKeybindings, isViewportTUI, ScrollView, setKeybindings, Text } from "@letty/letty-tui";
