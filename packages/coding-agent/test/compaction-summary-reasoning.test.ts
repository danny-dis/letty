...
import type { AssistantMessage, Context, Model } from "@letty/letty-ai";
...
vi.mock("@letty/letty-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@letty/letty-ai/compat")>();
	return {
		...actual,
...
describe("generateSummary reasoning options", () => {
	...
	it("leaves Anthropic refusal fallback handling to letty-ai model metadata", async () => {
		await generateSummary(
			messages,
