...
import { Text, type TUI, type TuiMouseEvent } from "@letty/letty-tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".letty", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .letty/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".letty", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .letty/AGENTS.override.md",
	...
	for (const scenario of [
		...
		{ title: "Letty documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
