> letty can create prompt templates. Ask it to build one for your workflow.
...
Letty loads prompt templates from:

- Global: `~/.letty/agent/prompts/*.md`
- Project: `.letty/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `letty.prompts` entries in `package.json`
