import { type AssistantMessageFrame, createModels, fauxAssistantMessage, fauxProvider } from "@letty/letty-ai";
		...
		await commit(session, [
			...
			storedValues.setValue(storedValues.operationState(operationId), {
				...
				generationContext: {
					...
					configuration,
					streamOptions: {},
					retryPolicy: { maxAttempts: 2, baseDelayMs: 0, maxAgentDelayMs: 30_000 },
