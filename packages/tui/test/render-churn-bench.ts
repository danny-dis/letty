 ...
 * frames on a layout mirroring letty's fullscreen interactive mode:
...
async function main(): Promise<void> {
	...
	const tui = new TuiAltScreen(terminal, false, "/tmp/letty-tui-bench");
	...
	const footer = new Text("\x1b[2m~/workspaces/letty  main  100k tokens\x1b[22m", 1, 0);
